...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"timestamp": 1704356642147.0488},
            datetime(2024, 1, 4, 8, 24, 2, 147049, tzinfo=timezone.utc),
        ),
        # regular unix timestamp
        (
            {"timestamp": 1704356730.163272},
            datetime(2024, 1, 4, 8, 25, 30, 163272, tzinfo=timezone.utc),
        ),
        # timestamp as string
        (
            {"timestamp": "1704356730.163272"},
        ...
        # isoformat timestamp
        (
            {"date-time": "2024-01-04T00:28:22Z"},
            datetime(2024, 1, 4, 0, 28, 22, tzinfo=timezone.utc),
        ),
        # regular date parts
